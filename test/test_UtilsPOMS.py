...
def test_handle_dates_1(utils_poms):
    ...
    (tmin, tmax, tmin_s, tmax_s,
     nextlink, prevlink,
     trange) = utils_poms.handle_dates(tmin="", tmax="", tdays="", baseurl="foo/")
...
def test_handle_dates_2(utils_poms):
    ...
    (tmin, tmax, tmin_s, tmax_s,
     nextlink, prevlink,
     trange) = utils_poms.handle_dates(tmin="",
                                       tmax="",
                                       tdays="7", baseurl="foo/")
...
def test_handle_dates_4(utils_poms):
    ...
    (tmin, tmax, tmin_s, tmax_s,
     nextlink, prevlink,
     trange) = utils_poms.handle_dates(tmin=str(now - datetime.timedelta(days=10)),
                                       tmax="",
                                       tdays="7", baseurl="foo/")
    assert (tmax - tmin == datetime.timedelta(days=7))
