...
def test_kill_jobs():
    ...
    output_killTask, c_obje_T, c_idr_T, task_idr_T, job_idr_T = mps.jobsPOMS.kill_jobs( ctx, submission_id=submission_id, confirm="yes", act="kill")  

    # all campaign
    output_killCampaign, c_obje_C, c_idr_C, task_idr_C, job_idr_C = mps.jobsPOMS.kill_jobs(ctx, campaign_stage_id="14", confirm="yes", act="kill")  
