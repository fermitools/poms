...
class Job(Base):
    ...
    job_id_ = Column('job_id ', BigInteger, primary_key=True, server_default=text("nextval('"jobs_job_id _seq"'::regclass)"))
...
class ServiceDowntime(Base):
    ...
    downtime_ended = Column(DateTime(True), nullable=False)
