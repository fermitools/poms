...
json_field_editor.dictstart = function (id) {
    ...
    res.push('<thead>');
    res.push('<tr>');
    res.push('<td>Key <a target="_blank" href="{{ site.url }}/docs/experimenters_corner/campaign_edit_help#Key"><i class="icon help circle link"></i></a></td>');
    res.push('<td>Value <a htarget="_blank" ref="{{ site.url }}/docs/experimenters_corner/campaign_edit_help#Value"><i class="icon help circle link"></i></a></td>');
    res.push('<td>&nbsp;</td>');
    res.push('</tr>');
    res.push('</thead>');
...
json_field_editor.start = function (id) {
    ...
    res.push('<tr>');
    res.push('<td>Key <a target="_blank" href="{{ site.url }}/docs/experimenters_corner/campaign_edit_help#Key"><i class="icon help circle link"></i></a></td>');
    res.push('<td align="center">Space<a target="_blank" href="{{ site.url }}/docs/experimenters_corner/campaign_edit_help#Space"><i class="icon help circle link"></i></a></td>');
    res.push('<td>Value <a htarget="_blank" ref="{{ site.url }}/docs/experimenters_corner/campaign_edit_help#Value"><i class="icon help circle link"></i></a></td>');
    res.push('<td>&nbsp;</td>');
    res.push('</tr>');
    res.push('</thead>');
