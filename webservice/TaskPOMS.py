...
class TaskPOMS:
    ...
    def init_statuses(self, dbhandle):
        ...
        self.status_Completed = (
            dbhandle.query(SubmissionStatus.status_id).filter(SubmissionStatus.status == "Completed").first()[0]
        )
        self.status_Removed = (
            dbhandle.query(SubmissionStatus.status_id).filter(SubmissionStatus.status == "Removed").first()[0]
        )
